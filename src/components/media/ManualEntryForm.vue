...
import { SUBTITLE_LABELS } from '@/types/media'
...
const subtitleLabel = computed(() => SUBTITLE_LABELS[props.type])
...
<template>
  <form class="manual" @submit.prevent="handleSubmit">
    ...
    <label class="manual__field">
      ...
      <input v-model="subtitle" type="text" :placeholder="subtitleLabel" />
    </label>
